...
jalan("\033[1;96m
jalan("\033[1;96m
jalan('\033[1;93m              Welcome to Dilshad JamaliGROUP
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dilshad Jamali
	    time.sleep(2)
            loop = 'false'
        else:
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print logo
		print "\033[1;97m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;93mDilshad jamali033[1;97m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬ •◈•"
	...
	p = ThreadPool(50)
	p.map(main, id)
	print "\033[1;96m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;93mBALOCHHACKER\033[1;96m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"
	print "  \033[1;93m«---•◈•---Dilshad Jamali--•◈•---»" #Dev:Baloch_hacker
	print '\033[1;96m✅Process Has Been Completed Press➡ Ctrl+Z.↩ Next Type (python2 Dilshad12.py↩\033[1;97m....'
